<?php
  ...
  if(isset($_GET['supplier'])){
    $cid = $_GET['supplier'];
    $supp = $db->getSupplierDetails($cid);
  }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                   ...
                   <h1><?php echo $supp['SUPPLIER_NAME']; ?></h1>
                   <hr />
                   
                   <b>Address: </b> <?php echo $supp['SUPPLIER_ADDRESS']; ?> <br />
                   <b>Contact Number: </b> <?php echo $supp['CONTACT_NUMBER']; ?> 
                   <hr />
