                            ...
                            <?php
                              for($i=0;$i<sizeof($employeeList);$i++){
                                ...
                                print "
                                  <tr>
                                    <td>
                                        <div class='cust-table-name'><a href='employee.php?employee=".$employeeList[$i]['id']."'>".$employeeList[$i]['last_name'].", ".$employeeList[$i]['first_name']." ".$employeeList[$i]['middle_name']."</a></div>
                                    </td>
