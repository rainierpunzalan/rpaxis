                            ...
                            <?php
                              for($i=0;$i<sizeof($voucherList);$i++){
                                ...
                                print "
                                  <tr>
                                    <td>
                                        <div class='cust-table-name'><a href=poDetails.php?po_no=".$voucherList[$i]['po_no'].">".$voucherList[$i]['voucher_no']."</a></div>
                                    </td>
                                    <td>".$voucherList[$i]['supplier_name']."</td>
                                    <td>".$voucherList[$i]['total_amount']."</td>
                                    <td>".$voucherList[$i]['due_date']."</td>
                                    <td>".$status."</td>
                                  </tr>
                                ";
                              }
